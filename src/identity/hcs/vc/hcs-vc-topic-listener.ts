 ...
 */
export class HcsVcTopicListener {
     ...
     */
    public addFilter(filter: (input: TopicMessage) => boolean): HcsVcTopicListener {
        if (!this.filters) {
            this.filters = [];
        }
     ...
     * @return This listener instance.
     */
    public subscribe(client: Client, receiver: (input: MessageEnvelope<HcsVcMessage>) => void): HcsVcTopicListener {
     ...
     */
    protected handleResponse(response: TopicMessage, receiver: (input: MessageEnvelope<HcsVcMessage>) => void) {
        if (this.filters) {
     ...
     */
    public onError(handler: (input: Error) => void): HcsVcTopicListener {
     ...
     * @return This transaction instance.
     */
    public onInvalidMessageReceived(handler: (t: TopicMessage, u: string) => void): HcsVcTopicListener {
        this.invalidMessageHandler = handler;
        return this;
    }

    public setStartTime(startTime: Timestamp): HcsVcTopicListener {
        this.query.setStartTime(startTime);
        return this;
    }

    public setEndTime(endTime: Timestamp): HcsVcTopicListener {
        this.query.setEndTime(endTime);
        return this;
    }

    public setLimit(messagesLimit: Long): HcsVcTopicListener {
        this.query.setLimit(messagesLimit);
        return this;
    }

    public setIgnoreErrors(ignoreErrors: boolean): HcsVcTopicListener {
